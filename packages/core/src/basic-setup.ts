...
export function basicSetup(
  ...
  return {
    ...
    keymap: {
      ...
      "shift-up": (editor) => editor.actions.move(0, -editor.getGridSize()[1]),
      "shift-down": (editor) => editor.actions.move(0, editor.getGridSize()[1]),
      "shift-left": (editor) =>
        editor.actions.move(-editor.getGridSize()[0], 0),
      "shift-right": (editor) =>
        editor.actions.move(editor.getGridSize()[0], 0),
      up: (editor) => editor.actions.move(0, -1),
      down: (editor) => editor.actions.move(0, 1),
      left: (editor) => editor.actions.move(-1, 0),
      right: (editor) => editor.actions.move(1, 0),
